package ru.otus.dobrovolsky.backend.dao;
...
public class DataSetDAO {
    ...
    public UserDataSet read(long id) {
        return (UserDataSet) session.createQuery(
                "select u " +
                        "from ru.otus.dobrovolsky.backend.dataSet.UserDataSet u " +
                        "where u.id = :id ")
                .setParameter("id", id)
                .setCacheable(true)
    ...
    public AddressDataSet readAddressById(long id) {
        return (AddressDataSet) session.createQuery(
                "select a " +
                        "from ru.otus.dobrovolsky.backend.dataSet.AddressDataSet a " +
                        "where user_id = :id ")
                .setParameter("id", id)
                .setCacheable(true)
                .setCacheRegion("ru.otus.dobrovolsky.base.dataSet.AddressDataSet")
                .getSingleResult();
    }
    ...
    public List<UserDataSet> readAll() {
        ...
        return session.createQuery(criteria).setCacheable(true).setCacheRegion("ru.otus.dobrovolsky.backend.dataSet.UserDataSet").list();
    }
}