...
public class DataSetDAO {
    ...
    public UserDataSet read(long id) {
        return (UserDataSet) session.createQuery(
                "select u " +
                        "from ru.otus.dobrovolsky.base.dataSets.UserDataSet u " +
                        "where u.id = :id ")
                .setParameter("id", id)
                .setCacheable(true)
//                .setCacheRegion("userById")
    ...
    public AddressDataSet readAddressById(long id) {
        return (AddressDataSet) session.createQuery(
                "select a " +
                        "from ru.otus.dobrovolsky.base.dataSets.AddressDataSet a " +
                        "where user_id = :id ")
                .setParameter("id", id)
                .setCacheable(true)
                .setCacheRegion("ru.otus.dobrovolsky.base.dataSets.AddressDataSet")
                .getSingleResult();
    }
    ...
    public UserDataSet readByName(String name) {
        ...
        Query<UserDataSet> query = session.createQuery(criteria).setCacheable(true).setCacheRegion("ru.otus" +
                ".dobrovolsky.base.dataSets.UserDataSet");
    ...
    public List<UserDataSet> readAll() {
        ...
        return session.createQuery(criteria).setCacheable(true).setCacheRegion("ru.otus.dobrovolsky.base.dataSets.UserDataSet").list();
    }
}